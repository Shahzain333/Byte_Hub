    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        ...
        <div className="text-center">
          ...
          <button onClick={() => navigate("/menu")} className="px-6 py-3 bg-[#FFB703] hover:bg-[#E09A05] 
  ...
  return (
    <div className='min-h-screen bg-gradient-to-b from-gray-50 to-white'>
      ...
      <div className='container mx-auto px-4 py-4 lg:py-8'>
        ...
        <button onClick={() => navigate('/menu')} className="flex items-center gap-2 text-gray-600 
        hover:text-[#FFB703] transition-colors group">
          ...
          <div className="relative">
            ...
            <div className="sticky top-8">
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl">
                ...
                <img src={menu.image} alt={menu.name} className="w-full h-[350px] lg:h-[480px] object-cover"/>
                ...
                <div className="absolute top-3 right-3 lg:top-6 lg:right-6">
                  ...
                  {menu.isAvailable ? (
                    ...
                    <div className="bg-green-500 text-white px-2 md:px-4 py-1 md:py-2 rounded-full flex items-center 
                    ...
                    <div className="bg-red-500 text-white px-2 md:px-4 py-1 md:py-2 rounded-full flex items-center 
                    gap-2 font-semibold shadow-lg">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="flex items-baseline gap-2">
                ...
                <span className="text-4xl font-bold text-[#FFB703] ">
                  ${menu.price}
                </span>
            ...
            <div className="bg-gradient-to-r from-[#FFB703] to-[#E09A05]  rounded-2xl p-6 shadow-xl">
