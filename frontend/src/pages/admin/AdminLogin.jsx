...
const AdminLogin = () => {
  ...
  return (
    <div className="py-16 lg:py-35 flex items-center justify-center">
      <form
        onSubmit={handleSubmit}
        className=" pb-12 w-full sm:w-[350px] text-center border border-zinc-300/60 
        dark:border-zinc-700 rounded-2xl px-8 bg-white dark:bg-zinc-900">
        ...
        <button
          type="submit"
          className="mt-6 w-full h-11 rounded-full text-white bg-[#E09A05] hover:opacity-90 
          transition-opacity cursor-pointer font-medium"
        >
