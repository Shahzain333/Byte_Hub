        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            ...
            <div className='flex items-center justify-between h-16'>
                ...
                <div className='hidden md:flex items-center space-x-8'>
                    ...
                    <Link to={"/book-table"} className="text-gray-700 hover:text-blue-600 transition-colors 
                    font-medium">
                        Book Table
                    </Link>
                ...
                <div className='flex items-center space-x-4'>
                    ...
                    <button onClick={() => navigate('/cart')} className='relative p-2 hover:bg-gray-100 
                    ...
                    <div className='hidden md:block'>
                        { user ? (
                            <div className='relative'>
                                ...
                                <button onClick={() => navigate('/login')} className='bg-orange-500 text-white px-6
                                py-2 rounded-lg hover:bg-orange-700 transition-colors font-medium cursor-pointer'>
                                    Login
                                </button>                           
                            )
                        }
            ...
            {/* Small Devices For Mobile Menu */}
            {
                isMenuOpen && (
                    <div className='md:hidden py-4 broder-t border-gray-200'>
