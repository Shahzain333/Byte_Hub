  ...
  return (
    <section className='py-8 md:py-16 bg-gradient-to-b from-gray-50 to-white'>
      ...
      <div className='container mx-auto px-4 text-center'>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-8 mt-4 md:mt-8">
          ...
          {categories.map((cat) => (
            ...
            <div key={cat._id} className="cursor-pointer group">
              ...
              <div className="relative">
                ...
                <div className="absolute inset-0 w-32 h-32 mx-auto rounded-full bg-gradient-to-t from-black/20 
